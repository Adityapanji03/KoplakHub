...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700;800;900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
    <!-- SweetAlert -->
...
<body class="bg-white font-poppins text-gray-200">

    <div class="container mx-auto px-4 py-8">
        <!-- Back Button -->
        <div class="mb-6 animate-fade-in">
            <a href="{{ route('profile.show') }}" class="p-2 border border-b-8 border-black rounded bg-koplak font-bold inline-flex items-center text-black hover:text-black-dark transition">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            <div class="flex items-center mb-6">
                                ...
                                <h3 class="text-xl font-bold">Informasi Personal</h3>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="nama" id="nama" value="{{ old('nama', $user->nama) }}"
                                           class="form-input block w-full rounded-lg py-2.5 px-4 focus:ring-2 focus:ring-koplak">
                                    @error('nama')
                        ...
                        <div>
                            <div class="flex items-center mb-6">
                                <div class="h-8 w-1 bg-koplak mr-3 rounded-full"></div>
                                <h3 class="text-xl font-bold">Informasi Alamat</h3>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="detail_alamat" id="detail_alamat" rows="3"
                                            class="form-input block w-full rounded-lg py-2.5 px-4 bg-darker border border-gray-600 text-gray-200 focus:ring-2 focus:ring-koplak focus:border-transparent">{{ old('detail_alamat', $user->detail_alamat) }}</textarea>
                                    @error('detail_alamat')
                                        <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                </div>
